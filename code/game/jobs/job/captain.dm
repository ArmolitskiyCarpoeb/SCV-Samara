...
The owner of the vast rusting hulk that is the SCV Samara. At least, as long as you keep up repayments.<br>\
...
You are a free agent, able to go where you will, and loyal to no particular government or nation. You are however, in quite a lot of debt. So wherever you go, you should be sure a profitable venture awaits."
	...
	loyalties = "Your first loyalty is to Samara, your ship. It is the purpose of your life, and you are nothing without it. If it were to be destroyed, you and your descendants would be ruined for centuries. <br>\
