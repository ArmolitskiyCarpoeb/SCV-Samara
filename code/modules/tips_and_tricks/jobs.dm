...
/tipsAndTricks/jobs/ironhammer_theft
    jobs_list = list(, , , , /datum/job/ihoper)
...
/tipsAndTricks/jobs/guild_resale_profit
    jobs_list = list(/datum/job/merchant, )
...
/tipsAndTricks/jobs/engies_tribe
    jobs_list = list(, /datum/job/technomancer)
...
/tipsAndTricks/jobs/changeAILaws
    jobs_list = list(/datum/job/captain, , , , /datum/job/hop, )
...
/tipsAndTricks/jobs/expeditionsAreFUN
    jobs_list = list(, /datum/job/scientist, )
...
/tipsAndTricks/jobs/chem_app
    jobs_list = list(, /datum/job/scientist, , , /datum/job/doctor, )
...
/tipsAndTricks/jobs/drink_app
    jobs_list = list(, /datum/job/clubmanager)
